...
namespace AudioSynthesis.Synthesis
{
    ...
    public struct MidiMessage
    {
        ...
        public MidiMessage(byte channel, byte command, byte data1, byte data2, double length = 0.0)
            : this(0, 0.0f, channel, command, data1, data2, length) { }
        public MidiMessage(int delta, double time, byte channel, byte command, byte data1, byte data2, double length)
        {
            this.delta = delta;
            this.time = time;
